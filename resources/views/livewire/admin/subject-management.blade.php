        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div class="relative bg-white rounded-2xl shadow-xl w-full max-w-2xl p-6 z-10">
                ...
                <form wire:submit.prevent="{{ $isEdit ? 'update' : 'save' }}"
                    ...
                    <div>
                        <input wire:model.defer="subject_code" type="text" placeholder="Subject Code"
                    ...
                    <div>
                        <input wire:model.defer="description" type="text" placeholder="Description"
                            class="border rounded-lg px-3 py-2 w-full">
                        @error('description')
                            <span class="text-red-500 text-xs">{{ $message }}</span>
                        @enderror
                    ...
                    <div>
                        <input wire:model.defer="unit" type="number" placeholder="Units"
                            class="border rounded-lg px-3 py-2 w-full">
                        @error('unit')
                            <span class="text-red-500 text-xs">{{ $message }}</span>
                        @enderror
                    ...
                    <div>
                        <input wire:model.defer="lec_hours" type="number" placeholder="Lecture Hours"
                            class="border rounded-lg px-3 py-2 w-full">
                        @error('lec_hours')
                            <span class="text-red-500 text-xs">{{ $message }}</span>
                        @enderror
                    ...
                    <div>
                        <input wire:model.defer="lab_hours" type="number" placeholder="Lab Hours"
                            class="border rounded-lg px-3 py-2 w-full">
                        @error('lab_hours')
                            <span class="text-red-500 text-xs">{{ $message }}</span>
                        @enderror
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div class="relative bg-white rounded-2xl shadow-xl w-full max-w-md p-6 z-10">
                ...
                <div class="flex justify-end gap-2">
                    ...
                    <button wire:click="deactivateSubject"
                        class="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg">Confirm Deactivate</button>
                </div>
            </div>
        </div>
    @endif
                ...
                @foreach ($subjects as $subject)
                    <tr class="border-b">
                        ...
                        <td class="flex gap-2 px-6 py-3">
                            ...
                            <button wire:click="confirmDeactivate({{ $subject->id }})"
